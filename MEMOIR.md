...
- **Model Choice**: Standardized on `gemini-2.5-flash` for its multi-modal capabilities and performance. In 2.1.0, switched to `gemini-flash-latest` long-term alias to ensure automatic version migration.
